...
class HomepagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homepage" do
    assert_difference('Homepage.count') do
      post homepages_url, params: { homepage: { lastname: @homepage.lastname, major: @homepage.major, name: @homepage.name, studentid: @homepage.studentid } }
    end
  ...
  test "should update homepage" do
    patch homepage_url(@homepage), params: { homepage: { lastname: @homepage.lastname, major: @homepage.major, name: @homepage.name, studentid: @homepage.studentid } }
